...
ny_noaa = ny_noaa %>% 
  ...
  mutate(
    prcp = prcp/10,
    # change the unit of snowfall from inch to mm
    snow = snow * 25.4,
...
### The number of days when tmax is larger than 0 in each station when precipitation, snowfall and snow depth aren't zero
